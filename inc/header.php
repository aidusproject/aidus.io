...
$decrypt = $__secure -> decrypt($encv);
//echo "<script>console.log('".$decrypt."');</script>";
...
<head>
    ...
    <link href="/css/aidus_pay.css" rel="stylesheet">
            ...
            <div class="container">
                ...
                <div class="col col-6 header_btn flex_r_r">
                    <a href="/aidus_pay_reserve.php">
                        <span class="reserve_event_btn white_btn cursor">
                            <?php
                            if($language == 'ko') {
                                echo "아이더스페이 2차 사전가입 이벤트";
                            }else if($language == 'cn'){
                                echo "AIDUS PAY 二次 早鸟注册活动";
                            }else {
                                echo "AIDUS PAY 2nd Pre-registration Event";
                            }
                            ?>
            ...
            <div class="container">
                ...
                <div class="header_nav">
                    ...
                    switch ($current_uri) {
                        ...
                        case "/daily_pay.php": $tab_ap      = $none_on_class;break;
                    }
                    ?>
                    <span <?=$tab_index    ?>>
                    ...
                    <span<?=$tab_ap?> data-id="menu-6" id="ap_menu">
                            <a class="header_menu_link flex_r" href="/daily_pay.php">AIDUS PAY</a>
                        </span>
                    ...
                    <div class="menu_box">
                        ...
                        <span class="menu_box_menu" data-id="coin">AIDUS TOKEN</span>
                    ...
                    <a class="header_menu_link flex_r" href="/platform.php">D-FUND PLATFORM</a>
                    <div class="menu_box">
                    ...
                    <span>
                        ...
                        <div class="buy_token_link_area" style="bottom: -270%;">
                            <div class="buy_token_link_box">
                                <a href="https://bitsonic.co.kr/front/exchange/aidus-krw" target="_blank">
                                <div class="buy_token_link">
                                    <img src="/images/icon/bitsonic.png">
                                    <span class="buy_token_link_text" id="">BITSONIC</span>
                                </div>
                                </a>
                                <a href="https://www.coinbene.com/spot/exchange/AIDUS_BTC" target="_blank">
                                <div class="buy_token_link">
                                    <img src="/images/icon/coinbene.png">
                                    <span class="buy_token_link_text" id="buy_coinbene">CoinBene</span>
                                </div>
                                </a>
                                <a href="https://www.digifinex.com/ko-kr/trade/USDT/AIDUS" target="_blank">
                                <div class="buy_token_link">
                                    <img src="/images/icon/digifinex.png">
                                    <span class="buy_token_link_text">DigiFinex</span>
                                </div>
                                </a>
                                <a href="https://coinsbit.io/ko/trade/AIDUS_BTC" target="_blank">
                                <div class="buy_token_link">
                                    <img src="/images/icon/coinsbit.png">
                                    <span class="buy_token_link_text">CoinsBit</span>
                                </div>
                                </a>
                                <a href="https://www.foblgate.com/trade?pairName=AIDUS/KRW" target="_blank">
                                <div class="buy_token_link">
                                    <img src="/images/icon/foblgate.png">
                                    <span class="buy_token_link_text">FoblGate</span>
                                </div>
                                </a>
                                <a href="https://bigonezh.com/trade/AIDUS-USDT" target="_blank">
                                <div class="buy_token_link">
                                    <img src="/images/icon/bigone.png">
                                    <span class="buy_token_link_text">BigONE</span>
                                </div>
                                </a>
                            </div>
                        </div>
        ...
        <div class="mobile_menu_area">
            <div class="mobile_menu_list">
                ...
                <div class="mobile_menu">
                    <a id="mobile_pay_menu" href="/aidus_pay_reserve.php">
                        <?php
                        if($language == 'ko') {
                            echo "아이더스페이 사전가입 이벤트";
                        }else if($language == 'cn'){
                            echo "AIDUS PAY 早鸟注册活动";
                        }else {
                            echo "AIDUS PAY Pre-registration Event";
                        }
                        ?>
                    </a>
                </div>
                <div class="mobile_menu"><a id="mobile_ap_menu" href="/daily_pay.php">AIDUS PAY</a></div>
                <div class="mobile_menu"><a href="/whyaidus.php">WHY AIDUS</a></div>
                <div class="mobile_menu"><a href="/platform.php">D-FUND PLATFORM</a></div>
                ...
                <div class="moba_buy_token_area">
                    <div class="moba_buy_token_box" style="margin-top: -220px;">
                        <a href="https://bitsonic.co.kr/front/exchange/aidus-krw" target="_blank">
                            <div class="moba_buy_token_link">
                                <img src="/images/icon/bitsonic.png" width="20"> BITSONIC
                            </div>
                        </a>
                        <a href="https://www.coinbene.com/spot/exchange/AIDUS_BTC" target="_blank">
                            <div class="moba_buy_token_link">
                        ...
                        <a href="https://www.digifinex.com/ko-kr/trade/USDT/AIDUS" target="_blank">
                            <div class="moba_buy_token_link">
                                <img src="/images/icon/digifinex.png" width="20"> DigiFinex
                            </div>
                        </a>
                        <a href="https://coinsbit.io/ko/trade/AIDUS_BTC" target="_blank">
                            <div class="moba_buy_token_link">
                                <img src="/images/icon/coinsbit.png" width="20"> CoinsBit
                            </div>
                        </a>
                        <a href="https://www.foblgate.com/trade?pairName=AIDUS/KRW" target="_blank">
                            <div class="moba_buy_token_link">
                                <img src="/images/icon/foblgate.png" width="20"> FoblGate
                            </div>
                        </a>
                        <a href="https://bigonezh.com/trade/AIDUS-USDT" target="_blank">
                            <div class="moba_buy_token_link">
                                <img src="/images/icon/bigone.png" width="20"> BigONE
                            </div>
                        </a>
                    </div>
                </div>
                ...
                $("#moba_buy_token").click(function(){
                    if($(this).hasClass('on')){
                        $(".moba_buy_token_box").css({
                            ...
                            'margin-top':'-220px',
                            'opacity':'0',
                            'transition':' opacity .2s ease-in-out, visibility .4s ease-in-out, margin .5s ease-in-out'
                        });
                        $(this).removeClass('on');
                    }else{
                        $(".moba_buy_token_box").css({
                            ...
                            'margin-top':'0',
                            'opacity':'1',
                            'transition':' opacity .8s ease-in-out, visibility .4s ease-in-out, margin .5s ease-in-out'
                        });
                        $(this).addClass('on');
                    }
