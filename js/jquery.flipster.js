        ...
        return this.each(function() {
            ...
            function buildButtons() {
                if ( settings.buttons && _items.length > 1 ) {
                    ...
                    $(".slide_area").append(buildButton('prev'), buildButton('next'));
            ...
            function center() {
                ...
                if ( _currentIndex >= 0 ) {
                    ...
                    if ( !_containerWidth || _itemOffsets[_currentIndex] === undefined ) { resize(false); }
            ...
            function jump(to) {
                ...
                center();
                //console.log("current_index => ", _currentIndex);
                //console.log("item_length => ", _items.length);
                if(_currentIndex > _items.length - 5){
                    currentViewIndex = _currentIndex
                    if(appendData == true) {
                        //console.log("currentViewIdx => ", currentViewIndex);
                        readMore(_currentIndex);
                    }
                }/*else if(_currentIndex < 5){
                    currentViewIndex = _currentIndex
                    if(appendData == true) {
                        //console.log("currentViewIdx => ", currentViewIndex);
                        readPrev(_currentIndex);
                    }
                }*/
