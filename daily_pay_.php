...
if($aidus_pay != 'Y') {
    ?>
    <!--<div class="aidus_pay_pop_mask" id="aidus_pay_pop">
        <div class="aidus_pay_pop">
            <div class="aidus_pay_pop_body">
                <div class="aidus_pay_pop_title margin-bottom-30">
                    <?/*=$lang_pack[66]*/?><br>
                    <br>
                    <?/*=$lang_pack[67]*/?>
                </div>
                <div class="aidus_pay_pop_text margin-bottom-30">
                    <span><?/*=$lang_pack[68]*/?></span>
                    <?/*=$lang_pack[69]*/?><br>
                    <?/*=$lang_pack[70]*/?><br>
                </div>
                <span id="aidus_pay_pop_close">X</span>
            </div>
            <div class="aidus_pay_pop_foot">
                <div class="aidus_pay_pop_btn close" id="aidus_pay_pop_btn_close">
                    CLOSE
                </div>
                <div class="aidus_pay_pop_btn">
...
<!--<div class="aidus_pay_pop_mask" id="aidus_pay_pop">
    <div class="aidus_pay_pop">
        <div class="aidus_pay_pop_body">
            <div class="aidus_pay_pop_title margin-bottom-30">
                <?/*=$aidus_pay_pop_lang[0]*/?><br>
                <br>
                <?/*=$aidus_pay_pop_lang[1]*/?>
            </div>
            <div class="aidus_pay_pop_text margin-bottom-30">
                <span><?/*=$aidus_pay_pop_lang[2]*/?></span>
