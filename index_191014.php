    ...
    <section class="main_top">
        <div class="main_top_slide_area" id="main_top_slide">
            ...
            <div class="main_top_slide_box box2" data-idx="2">
                <div class="main_top_slide_before">
                    <div class="main_top_slide_title temp_title">
                        <?=$lang_pack[27] ?>
                        <!--<div class="main_top_slide_sub" id="main_slide"></div>-->
                        <div class="main_top_slide_sub temp_slide_sub">
                            IRR : <span class="temp_slide_text">+88.39%</span>
                            <br>
                            <?=$lang_pack[28] ?><span class="temp_slide_text">178.86%</span>
                            <br>
                            <?=$lang_pack[29] ?><span class="temp_slide_text"><?=$lang_pack[30] ?></span>
                        </div>
                        <div class="main_top_slide_whyaidus temp_sub_title"><?=$lang_pack[31] ?></div>
                    </div>
                    <div class="main_top_slide_click_title">QTS <?=$lang_pack[17] ?></div>
                </div>
                <div class="in_box box2">
                    <div class="in_box_division chart_box" style="width: 100%;">
                        <div class="temp_top_box">
                            <div class="temp_box_title"><?=$lang_pack[32] ?></div>
                            <div class="temp_box_sub"><?=$lang_pack[33] ?></div>
                            <div class="temp_box_sub"><?=$lang_pack[34] ?></div>
                            <div class="temp_box_sub"><?=$lang_pack[35] ?></div>
                        </div>

                        <div class="temp_bot_box">
                            <div class="temp_bot_division">
                                <div class="temp_bot_title">
                                    <?=$lang_pack[36] ?>
                                </div>
                                <div class="temp_bot_sub">IRR : <span style="color: #ff0000;font-size: 24px;">+88.39%</span></div>
                                <div class="temp_bot_sub"><?=$lang_pack[37] ?> : <span style="color: #ff0000;font-size: 24px;">178.86%</span></div>
                                <div class="temp_bot_sub"><?=$lang_pack[38] ?> : <span style="color: #ff0000;font-size: 24px;"><?=$lang_pack[39] ?></span></div>
                            </div>
                            <div class="temp_bot_division" style="float:right;">
                                <div class="temp_bot_title">
                                    <?=$lang_pack[40] ?>
                                </div>
                                <div class="temp_bot_sub"><?=$lang_pack[41] ?></div>
                            </div>
                        </div>
                    </div>
