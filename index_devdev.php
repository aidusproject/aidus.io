<?php
include_once ("{$_SERVER['DOCUMENT_ROOT']}/inc/header_devdev.php");
...
$y_axis_max = round((((int)array_pop($y_axis) + 10)/10)*10);
?>
            ...
            <div class="main_top_slide_box box1" id="main_top_slide_box1" data-idx="1">
                ...
                <div class="in_box box1">
                    ...
                    <div class="in_box_division">
                        ...
                        <div class="division_sub">
                            <span class="division_sub_sm">World Top 100 Hedge Fund <?=$lang_pack[15] ?></span>
